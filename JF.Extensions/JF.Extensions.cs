...
namespace JF
{
	...
	public static class Extensions
	{
		...
		/// <param name="s"></param>
		/// <returns></returns>
		public static string ToTitleCaseEx(this string s)
		{
			// This will build a Titlecased string, but will 
			// uppercase any letter's that appear after 
			// apostrophes (as in names)
			var titlecase = CultureInfo.CurrentCulture.TextInfo.ToTitleCase(s.ToLowerInvariant());
		...
		/// <param name="cultureinfo"></param>
		/// <returns></returns>
		public static string ToTitleCaseEx(this string s, CultureInfo cultureinfo)
		{
			// This will build a Titlecased string, but will 
			// uppercase any letter's that appear after 
			// apostrophes (as in names)
			var titlecase = cultureinfo.TextInfo.ToTitleCase(s.ToLowerInvariant());
			// Replaces any character after an apostrophe or 
			// hyphen with its uppercase variant
			return Regex.Replace(titlecase, @"['-](?:.)", m => m.Value.ToUpperInvariant());
		}
		...
		/// <summary>
		/// Génère un hash MD5 d'une chaîne
		/// </summary>
		...
		public static string[] SplitAndTrim(this string text, string separator)
		{
			...
			return Regex.Split(text, separator).Select(t => t.Trim()).ToArray();
		}
		/// <summary>
		/// Nettoie une chaîne pour ne garder que les chiffres
		/// </summary>
		/// <param name="text">Chaîne d'entrée</param>
		/// <returns>La chaîne où il ne reste que des chiffres</returns>
		public static string DigitOnly(this string text)
		{
		...
		public static string ToStringLinq(this object o)
		{
			return o.GetType().FullName
				+ new string('=', o.GetType().FullName.Length)
				+ Environment.NewLine
				+ string.Join(Environment.NewLine, (from p in o.GetType().GetProperties()
													select string.Format("{0,25} : {1}", p.Name, p.GetValue(o, null))))
				+ Environment.NewLine
				+ new string('-', 30)
				+ Environment.NewLine;
		}
		...
		#region Calcul d'âge
		/// <summary>
		/// Calcule un âge par rapport à la date du jour
		/// </summary>
		/// <param name = "dob">Date de naissance</param>
		/// <returns>L'âge calculé</returns>
		public static int CalculateAge(this DateTime dob)
		{
			return CalculateAge(dob, DateTime.Today);
		}
		/// <summary>
		/// Calcule un âge par rapport à une date de référence
		/// </summary>
		...
		public static bool IsWorkingDay(this DateTime date)
		{
			...
			// 01 Janvier
			arrDateFerie.SetValue(new DateTime(date.Year, 1, 1), 0);
			// 01 Mai
			arrDateFerie.SetValue(new DateTime(date.Year, 5, 1), 1);
			// 08 Mai
			arrDateFerie.SetValue(new DateTime(date.Year, 5, 8), 2);
			// 14 Juillet
			arrDateFerie.SetValue(new DateTime(date.Year, 7, 14), 3);
			// 15 Aout
			arrDateFerie.SetValue(new DateTime(date.Year, 8, 15), 4);
			// 01 Novembre
			arrDateFerie.SetValue(new DateTime(date.Year, 11, 1), 5);
			// 11 Novembre
			arrDateFerie.SetValue(new DateTime(date.Year, 11, 11), 6);
			// Noël
			arrDateFerie.SetValue(new DateTime(date.Year, 12, 25), 7);

			// Dimanche ou jour férié
			bool bolWorkingDay = !(date.DayOfWeek == DayOfWeek.Sunday || Array.BinarySearch(arrDateFerie, date) >= 0);
			if (bolWorkingDay)
			{
				...
				bolWorkingDay = !((DateTime.Compare(dtMondayPaques, date) == 0) || (DateTime.Compare(dtAscension, date) == 0)
				|| (DateTime.Compare(dtMondayPentecote, date) == 0));
			}
		...
		/// <returns></returns>
		public static string StringValue(this XElement el, XName sTag)
		{
			string s;
			try
			{
		...
		/// <returns></returns>
		public static string StringValue(this XElement el, XName sTag, string sDefault)
		{
			string s;
			try
			{
		...
		/// <param name="sDefault"></param>
		/// <returns></returns>
		public static string StringAttValue(this XElement el, XName sAtt, string sDefault)
		{
			XAttribute a;
			string s;
			try
		...
		/// <param name="sAtt"></param>
		/// <returns></returns>
		public static string StringAttValue(this XElement el, XName sAtt)
		{
			XAttribute a;
			string s;
			try
		...
		/// <returns></returns>
		public static int IntValue(this XElement el, XName sTag, int nDefault)
		{
			int n;
			try
			{
		...
		/// <param name="sTag"></param>
		/// <returns></returns>
		public static int IntValue(this XElement el, XName sTag)
		{
			int nDefault = 0;
			int n;
			try
		...
		/// <param name="nDefault"></param>
		/// <returns></returns>
		public static int IntAttValue(this XElement el, XName sAtt, int nDefault)
		{
			XAttribute a;
			int n;
			try
		...
		/// <param name="sAtt"></param>
		/// <returns></returns>
		public static int IntAttValue(this XElement el, XName sAtt)
		{
			int nDefault = 0;
			XAttribute a;
			int n;
		...
		/// <param name="nDefault"></param>
		/// <returns></returns>
		public static long IntValue(this XElement el, XName sTag, long nDefault)
		{
			long n;
			try
			{
				...
				if (elt != null)
				{
					if (!long.TryParse(elt.Value, out n))
					{
						n = nDefault;
					}
				}
		...
		/// <param name="sTag"></param>
		/// <returns></returns>
		public static long LongValue(this XElement el, XName sTag)
		{
			long nDefault = 0;
			long n;
			try
		...
		/// <param name="nDefault"></param>
		/// <returns></returns>
		public static long LongAttValue(this XElement el, XName sAtt, long nDefault)
		{
			XAttribute a;
			long n;
			try
			{
				...
				if (a != null)
				{
					if (!long.TryParse(a.Value, out n))
					{
						n = nDefault;
					}
				}
		...
		/// <param name="sAtt"></param>
		/// <returns></returns>
		public static long LongAttValue(this XElement el, XName sAtt)
		{
			long nDefault = 0;
			XAttribute a;
			long n;
		...
		/// <returns></returns>
		public static bool BoolValue(this XElement el, XName sTag, bool bDefault)
		{
			bool bRet;
			try
			{
		...
		/// <param name="sTag"></param>
		/// <returns></returns>
		public static bool BoolValue(this XElement el, XName sTag)
		{
			bool bDefault = false;
			bool bRet;
			try
		...
		/// <param name="bDefault"></param>
		/// <returns></returns>
		public static bool BoolAttValue(this XElement el, XName sAtt, bool bDefault)
		{
			XAttribute a;
			bool bRet;
			try
		...
		/// <param name="sAtt"></param>
		/// <returns></returns>
		public static bool BoolAttValue(this XElement el, XName sAtt)
		{
			bool bDefault = false;
			XAttribute a;
			bool bRet;
		...
		/// <returns></returns>
		public static double DoubleValue(this XElement el, XName sTag, double fDefault)
		{
			double n;
			try
			{
		...
		/// <param name="fDefault"></param>
		/// <returns></returns>
		public static double DoubleValue(this XElement el, XName sTag, CultureInfo ci, double fDefault)
		{
			double n;
			try
			{
		...
		/// <param name="sTag"></param>
		/// <returns></returns>
		public static double DoubleValue(this XElement el, XName sTag)
		{
			double fDefault = 0;
			double n;
			try
		...
		/// <param name="ci"></param>
		/// <returns></returns>
		public static double DoubleValue(this XElement el, XName sTag, CultureInfo ci)
		{
			double fDefault = 0;
			double n;
			try
		...
		/// <param name="fDefault"></param>
		/// <returns></returns>
		public static double DoubleAttValue(this XElement el, XName sAtt, double fDefault)
		{
			XAttribute a;
			double n;
			try
		...
		/// <param name="fDefault"></param>
		/// <returns></returns>
		public static double DoubleAttValue(this XElement el, XName sAtt, CultureInfo ci, double fDefault)
		{
			XAttribute a;
			double n;
			try
		...
		/// <param name="sAtt"></param>
		/// <returns></returns>
		public static double DoubleAttValue(this XElement el, XName sAtt)
		{
			double fDefault = 0;
			XAttribute a;
			double n;
		...
		/// <param name="ci"></param>
		/// <returns></returns>
		public static double DoubleAttValue(this XElement el, XName sAtt, CultureInfo ci)
		{
			double fDefault = 0;
			XAttribute a;
			double n;
		...
		/// <param name="sAtt"></param>
		/// <param name="Value"></param>
		public static void SetAttribute(this XElement el, XName sAtt, object Value)
		{
			XAttribute a;
			a = el.Attribute(sAtt);
			if (a == null)
